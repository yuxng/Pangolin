...
FactoryRegistry<WindowInterface>::I().RegisterFactory(factory, 8, "linux");
FactoryRegistry<WindowInterface>::I().RegisterFactory(factory, 8, "winapi");
FactoryRegistry<WindowInterface>::I().RegisterFactory(factory, 8, "cocoa");
}
